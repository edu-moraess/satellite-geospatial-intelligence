...
# ============================================================
# PAGE CONFIG & CSS PROFISSIONAL (DARK GEOSPATIAL)
# ============================================================
...
# ============================================================
# DISPLAY SEARCH RESULTS (Expander)
# ============================================================
if items:
...
# ============================================================
# LAYOUT PRINCIPAL EM ABAS (DASHBOARD)
# ============================================================
if data:
    ...
    with tab1:
        ...
        with controls_col:
            ...
            st.caption("Visual do mapa 3D com inclinação.")
            st.info("Utilize os controles de zoom e inclinação no menu acima do mapa.")
