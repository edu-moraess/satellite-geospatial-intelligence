...
def ensure_output_directory(
    ...
    if not current.is_dir():
        ...
        raise RuntimeError(
            "Filesystem conflict detected — cannot create the "
            "scene directory.\n\n"
            f"Expected a directory but found a file at:\n"
            f"{current}\n\n"
            f"Target scene directory:\n"
            f"{output_directory}\n\n"
            "This is a structural conflict above the scene "
            "folder itself, so it was not auto-resolved. "
